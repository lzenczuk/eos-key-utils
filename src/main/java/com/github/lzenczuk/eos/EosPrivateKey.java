...
public class EosPrivateKey {
    ...
    public EosPrivateKey(String keyInWalletImportFormat) throws EosKeyExpection {
    ...
    public EosPublicKey getPublicKey() throws EosKeyExpection {
    ...
    public String toWif() throws EosKeyExpection {
        try {
    ...
    public byte[] sign(String data) throws EosKeyExpection {
        return sign(data.getBytes());
    }

    public byte[] sign(byte[] dataBytes) throws EosKeyExpection {
        ...
        try {
            ...
            throw new EosKeyExpection("Missing algorithm when getting Signature instance. Check is Bouncing Castle is in dependencies and is it set as security provider \"Security.addProvider(new BouncyCastleProvider())\"");
        } catch (SignatureException e) {
            throw new EosKeyExpection("Error updating or creating signature", e);
        } catch (InvalidKeyException e) {
            throw new EosKeyExpection("Error initializing signature with private key", e);
        }
    }
}
